...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='';
   menuActividades='<h1></h1><a href="javascript:irA(0)" title="colorear">1 </a><a href="javascript:irA(1)" title="ordenar frases">2 </a><a href="javascript:irA(2)" title="ordenar parrafos">3 </a>';
...
taboaContidos[0]=new act("colorear","colorear","","<object width='100%' height='420' type='text/html' data='colorear/colorear.htm'></object>",true,"",true,false,false);
taboaContidos[1]=new act("ordenar frases","ordenar frases","","<object width='100%' height='420' type='text/html' data='ordenar_frases/ordenar_frases.htm'></object>",true,"",true,false,false);
taboaContidos[2]=new act("ordenar parrafos","ordenar parrafos","","<object width='100%' height='420' type='text/html' data='ordenar_parrafos/ordenar_parrafos.htm'></object>",true,"",true,false,false);
